                ...
                <!-- /.row -->
                 ...
                 <div class="row">
                    <div class="col-lg-8">
                        ...
                        <form role="form" action="<?php echo $base_url."index.php/admin/edit_karyawan" ?>" method="post" enctype="multipart/form-data">
							<input type="hidden" id="id" name="id" value="<?php echo $id;?>">
                            <div class="form-group">
                                <label>Nama</label>
                                <input class="form-control" name="nama" placeholder="Nama" value="<?php echo $nama?>">
                            </div>
							<div class="form-group">
                                <label>Umur</label>
                                <input class="form-control" name="umur" placeholder="Umur" value="<?php echo $umur?>">
                            </div>
							<div class="form-group">
                                <label>Alamat</label>
								<textarea class="form-control" name="alamat" placeholder="Alamat" rows="3"><?php echo $alamat?></textarea>
                            </div>
