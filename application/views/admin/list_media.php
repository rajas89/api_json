...
<head>
	...
	<script type="text/javascript">
	  function confirmDelete(id){
		...
		if(conf) 
		window.location='<?php echo $base_url."index.php/admin/delete_media/"?>'+id;
	}
	</script>
</head>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
				...
				<div class="row">
                    <div class="col-lg-12">
						<a href="<?php echo $base_url;?>index.php/admin/add_media" style="float:right">
					...
					<?php foreach ($data_media as $a) {?> 
						<tr role="row" class="odd">
							...
							<td align="center" colspan="2">
								<a href="<?php echo $base_url;?>index.php/admin/edit_media/<?php echo $a->media_id;?>">
