...
<head>
	...
	<script type="text/javascript">
	  function confirmDelete(id){
		...
		if(conf) 
		window.location='<?php echo $base_url."index.php/admin/delete_page/"?>'+id;
	}
	</script>
</head>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
				...
				<div class="row">
                    <div class="col-lg-12">
                    	<a href="<?php echo $base_url;?>index.php/admin/flush_data" style="float:right">
								<button type="button" class="btn btn-default">Flush Cache</button>
						</a>
						<a href="<?php echo $base_url;?>index.php/admin/add_page" style="float:right;margin-right:10px">
					...
					<?php foreach ($data_page as $a) {?> 
						<tr role="row" class="odd">
							...
							<td align="center" colspan="2">
								...
								<a href="<?php echo $base_url;?>index.php/admin/edit_page/<?php echo $a->page_id;?>">
