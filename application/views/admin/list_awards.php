...
<head>
	...
	<script type="text/javascript">
	  function confirmDelete(id){
		...
		if(conf) 
		window.location='<?php echo $base_url."index.php/admin/delete_awards/"?>'+id;
	}
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
				...
				<div class="row">
                    <div class="col-lg-12">
						<a href="<?php echo $base_url;?>index.php/admin/add_awards" style="float:right">
					...
					<?php foreach ($data_awards as $a) {?> 
						<tr role="row" class="odd">
							...
							<td align="center" colspan="2">
								<a href="<?php echo $base_url;?>index.php/admin/edit_awards/<?php echo $a->awards_id;?>">
